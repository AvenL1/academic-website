...
<div style="line-height: 1.8; font-size: 1.1rem; color: #222; text-align: justify; margin-bottom: 40px;">
...
<!-- ========================================== -->
<div style="margin-top: 50px; margin-bottom: 25px; border-bottom: 2px solid #222; padding-bottom: 8px;">
  <h3 style="font-weight: bold; font-size: 1.5rem; color: #111; display: flex; align-items: center;">
    <i class="fas fa-briefcase" style="margin-right: 12px; color: #111; font-size: 1.3rem;"></i> Academic Positions
  </h3>
</div>

<div style="display: flex; flex-direction: column; gap: 20px; margin-bottom: 40px; padding-left: 8px;">
  <div style="display: flex; align-items: flex-start; gap: 25px;">
    <div style="min-width: 110px; color: #222; font-weight: bold; font-size: 1.05rem;">Since 01/2022</div>
    <div>
  ...
  <div style="display: flex; align-items: flex-start; gap: 25px;">
    <div style="min-width: 110px; color: #222; font-weight: bold; font-size: 1.05rem;">2019 — 2021</div>
    <div>
  ...
  <div style="display: flex; align-items: flex-start; gap: 25px;">
    <div style="min-width: 110px; color: #222; font-weight: bold; font-size: 1.05rem;">2018 — 2019</div>
    <div>
  ...
  <div style="display: flex; align-items: flex-start; gap: 25px;">
    <div style="min-width: 110px; color: #222; font-weight: bold; font-size: 1.05rem;">2015</div>
    <div>
...
<div style="margin-top: 50px; margin-bottom: 25px; border-bottom: 2px solid #222; padding-bottom: 8px;">
  <h3 style="font-weight: bold; font-size: 1.5rem; color: #111; display: flex; align-items: center;">
    <i class="fas fa-graduation-cap" style="margin-right: 12px; color: #111; font-size: 1.3rem;"></i> Education
  </h3>
</div>

<div style="display: flex; flex-direction: column; gap: 20px; margin-bottom: 40px; padding-left: 8px;">
  <div style="display: flex; align-items: flex-start; gap: 25px;">
    <div style="min-width: 110px; color: #222; font-weight: bold; font-size: 1.05rem;">2013 — 2018</div>
    <div>
  ...
  <div style="display: flex; align-items: flex-start; gap: 25px;">
    <div style="min-width: 110px; color: #222; font-weight: bold; font-size: 1.05rem;">2009 — 2013</div>
    <div>
...
<!-- ========================================== -->
<!-- SECTION: RESEARCH GRANTS (修复：标签换行) -->
<!-- ========================================== -->
<div style="margin-top: 50px; margin-bottom: 25px; border-bottom: 2px solid #222; padding-bottom: 8px;">
  <h3 style="font-weight: bold; font-size: 1.5rem; color: #111; display: flex; align-items: center;">
    <i class="fas fa-file-invoice-dollar" style="margin-right: 12px; color: #111; font-size: 1.3rem;"></i> Research Grants
  </h3>
</div>

<div style="display: flex; flex-direction: column; gap: 18px; margin-bottom: 40px;">
  <div style="background: #fdfdfd; border-left: 5px solid #222; padding: 16px 20px; border-radius: 0 6px 6px 0; box-shadow: 0 1px 4px rgba(0,0,0,0.08);">
    <div style="display: flex; flex-direction: column; gap: 8px; align-items: flex-start;">
      ...
      <span style="background: #eee; color: #222; border: 1px solid #ccc; padding: 3px 10px; border-radius: 4px; font-size: 0.85em; font-weight: bold; letter-spacing: 0.5px;">1.07M | ITF-ITSP</span>
    </div>
  ...
  <div style="background: #fdfdfd; border-left: 5px solid #222; padding: 16px 20px; border-radius: 0 6px 6px 0; box-shadow: 0 1px 4px rgba(0,0,0,0.08);">
    <div style="display: flex; flex-direction: column; gap: 8px; align-items: flex-start;">
      ...
      <span style="background: #eee; color: #222; border: 1px solid #ccc; padding: 3px 10px; border-radius: 4px; font-size: 0.85em; font-weight: bold; letter-spacing: 0.5px;">0.3M | NSFC Young Scientists</span>
    </div>
  ...
  <div style="background: #fdfdfd; border-left: 5px solid #222; padding: 16px 20px; border-radius: 0 6px 6px 0; box-shadow: 0 1px 4px rgba(0,0,0,0.08);">
    <div style="display: flex; flex-direction: column; gap: 8px; align-items: flex-start;">
      ...
      <span style="background: #eee; color: #222; border: 1px solid #ccc; padding: 3px 10px; border-radius: 4px; font-size: 0.85em; font-weight: bold; letter-spacing: 0.5px;">0.1M | Guangdong Regional Joint Fund</span>
    </div>
  ...
  <div style="background: #fdfdfd; border-left: 5px solid #222; padding: 16px 20px; border-radius: 0 6px 6px 0; box-shadow: 0 1px 4px rgba(0,0,0,0.08);">
    <div style="display: flex; flex-direction: column; gap: 8px; align-items: flex-start;">
      ...
      <span style="background: #eee; color: #222; border: 1px solid #ccc; padding: 3px 10px; border-radius: 4px; font-size: 0.85em; font-weight: bold; letter-spacing: 0.5px;">0.25M | PolyU Start-up Fund</span>
    </div>
...
<div style="margin-top: 50px; margin-bottom: 25px; border-bottom: 2px solid #222; padding-bottom: 8px;">
  <h3 style="font-weight: bold; font-size: 1.5rem; color: #111; display: flex; align-items: center;">
    <i class="fas fa-trophy" style="margin-right: 12px; color: #111; font-size: 1.3rem;"></i> Awards & Honors
  </h3>
</div>

<div style="display: flex; flex-direction: column; gap: 16px; margin-bottom: 40px; color: #222; padding-left: 5px;">
  <div style="display: flex; align-items: baseline; gap: 20px;">
    <span style="color: #222; min-width: 80px; font-weight: bold; font-size: 1.05rem;">11/2021</span>
    <span><strong style="color: #222; background: #eee; padding: 2px 6px; border-radius: 3px; border: 1px solid #ccc;">Grand Prize & First Prize</strong>, The 7th Hong Kong University Student Innovation and Entrepreneurship Competition</span>
  </div>
  <div style="display: flex; align-items: baseline; gap: 20px;">
    <span style="color: #222; min-width: 80px; font-weight: bold; font-size: 1.05rem;">05/2020</span>
    <span><strong>Postdoctoral Fellowship Scheme</strong>, The Research Grants Council (RGC, Hong Kong)</span>
  </div>
  <div style="display: flex; align-items: baseline; gap: 20px;">
    <span style="color: #222; min-width: 80px; font-weight: bold; font-size: 1.05rem;">10/2019</span>
    <span><strong>Distinguished Postdoctoral Fellowship</strong>, The Hong Kong Polytechnic University</span>
  </div>
  <div style="display: flex; align-items: baseline; gap: 20px;">
    <span style="color: #222; min-width: 80px; font-weight: bold; font-size: 1.05rem;">05/2017</span>
    <span><strong>Best Poster Award</strong>, The 4th Conference on New Generation Solar Cells (Beijing)</span>
  </div>
  <div style="display: flex; align-items: baseline; gap: 20px;">
    <span style="color: #222; min-width: 80px; font-weight: bold; font-size: 1.05rem;">12/2014</span>
    <span>New Student Scholarship, Peking University</span>
  </div>
  <div style="display: flex; align-items: baseline; gap: 20px;">
    <span style="color: #222; min-width: 80px; font-weight: bold; font-size: 1.05rem;">06/2013</span>
    <span>Outstanding Graduate, University of Science and Technology Beijing</span>
  </div>
  <div style="display: flex; align-items: baseline; gap: 20px;">
    <span style="color: #222; min-width: 80px; font-weight: bold; font-size: 1.05rem;">11/2012</span>
...
<div style="margin-top: 50px; margin-bottom: 25px; border-bottom: 2px solid #222; padding-bottom: 8px;">
  <h3 style="font-weight: bold; font-size: 1.5rem; color: #111; display: flex; align-items: center;">
    <i class="fas fa-users" style="margin-right: 12px; color: #111; font-size: 1.3rem;"></i> Synergistic Activities
  </h3>
</div>

<div style="display: flex; flex-direction: column; gap: 16px; margin-bottom: 20px; color: #222; padding-left: 5px;">
  <div style="display: flex; align-items: flex-start; gap: 12px;">
    <i class="fas fa-check-circle" style="color: #222; margin-top: 5px; font-size: 1rem;"></i>
    <div><strong>Journal Referee:</strong> <em>Nature Communications, Advanced Materials, Joule, Small</em>, etc.</div>
  </div>
  <div style="display: flex; align-items: flex-start; gap: 12px;">
    <i class="fas fa-edit" style="color: #222; margin-top: 5px; font-size: 1rem;"></i>
  ...
  <div style="display: flex; align-items: flex-start; gap: 12px;">
    <i class="fas fa-microphone" style="color: #222; margin-top: 5px; font-size: 1rem;"></i>
